...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_post_list_item, null, false); // inflate single line of recyclerView
    ...
    // Custom inner ViewHolder class for RecyclerView
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(Post post){
            ...
            // if post has no comments, show progress bar
        ...
        // simple method to show and hide progress bar
